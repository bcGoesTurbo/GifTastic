...
{
    var topics = ['Reaction GIFs', 'Entertainment', 'Sports', 'stickers'];
    ...
    function displayInfo()
    {
        ...
        var queryURL = 'https://api.giphy.com/v1/gifs/search?q=' + topic + '&api_key=CTWwwCrTaC3qjcZrQ1Gltt6PzIUoWr6l&limit=10';
